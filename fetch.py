#!/usr/bin/env python3
"""
Recuperation des codes promo Vision Direct depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/visiondirect.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/visiondirect.fr"
STORE_NAME = "Vision Direct"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Vision Direct depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-visiondirect)"
    }
    try:
